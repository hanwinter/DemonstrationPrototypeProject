  ...
  <section class="visit-card postpartum-analysis-card">
    ...
    <section class="analysis-section">
      ...
      <div class="task-toolbar">
        ...
        <div class="head-tools"><span class="advisor-total">顾问总数：{{ advisorTotal }}人</span><button class="config-link" type="button" aria-label="回访阶段展示设置" title="回访阶段展示设置" @click="openStageSettings"><el-icon><Setting /></el-icon></button></div>
      </div>
...
.analysis-head{display:flex;align-items:center;justify-content:space-between;gap:24px;margin-bottom:18px;padding:0;background:transparent}
...
.analysis-section{margin-top:26px}.analysis-section:first-of-type{margin-top:0}.risk-section{margin-top:28px;padding-top:22px;border-top:1px solid #edf1f5}
.submodule-head{margin:0 0 12px;padding:0 0 2px;display:flex;align-items:center;justify-content:space-between;gap:20px;background:#fff}.submodule-head h3{margin:0;display:flex;align-items:center;color:#1f2937;font-size:15px;font-weight:600}.submodule-head h3::before{content:"";width:3px;height:24px;margin-right:10px;border-radius:999px;background:#8fb4ff}.submodule-head label,.dimension-head label,.task-toolbar label{display:flex;align-items:center;gap:8px;color:#374151;font-size:13px;white-space:nowrap}
.task-toolbar{margin:0 0 12px;display:flex;align-items:center;justify-content:space-between;gap:20px}
.tool-select{width:120px}.stage-select{width:168px}.advisor-total{color:#475467;font-size:13px}.config-link{width:24px;height:24px;padding:0;display:inline-flex;align-items:center;justify-content:center;border:0;background:transparent;color:#98a2b3;font-size:16px;line-height:1;cursor:pointer}.config-link:hover{color:#667085}.text-link{height:auto;padding:0;border:0;background:transparent;color:#667085;font-size:12px;font-weight:500;cursor:pointer}.text-link:hover{text-decoration:underline}
