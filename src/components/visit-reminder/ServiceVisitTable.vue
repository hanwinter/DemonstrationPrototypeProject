...
<template>
  <section class="visit-card task-card">
    <div class="section-head"><h2>服务回访分析</h2><el-tooltip content="根据订单服务日期生成服务阶段回访任务。" placement="top"><button class="hint-btn" type="button" aria-label="服务回访分析说明"><el-icon><InfoFilled /></el-icon></button></el-tooltip></div>
